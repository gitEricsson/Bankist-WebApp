...
const formatMovementDate = function (date, locale) {
    const calcDaysPassed = (date1, date2) => Math.round(Math.abs(date2.getTime() - date1.getTime()) / (1000 * 60 * 60 * 24));
...
btnLogin.addEventListener('click', function (e) {
    ...
    if ((currentAccount === null || currentAccount === void 0 ? void 0 : currentAccount.pin) === +inputLoginPin.value) {
...
btnLoan.addEventListener('click', function (e) {
    ...
    if (amount > 0 &&
        (currentAccount === null || currentAccount === void 0 ? void 0 : currentAccount.movements.some(mov => mov >= amount * 0.1))) {
        setTimeout(function () {
            // Add movement
            currentAccount.movements.push(amount);
            // Add loan date
...
btnClose.addEventListener('click', function (e) {
    e.preventDefault();
    if (inputCloseUsername.value === (currentAccount === null || currentAccount === void 0 ? void 0 : currentAccount.username) &&
        +inputClosePin.value === (currentAccount === null || currentAccount === void 0 ? void 0 : currentAccount.pin)) {
